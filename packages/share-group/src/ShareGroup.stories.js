...
// import { Facebook, Twitter, Mail, Replay, Icon } from '@ssgw/icon/src';
import { Facebook, Twitter, Mail, Replay, Icon } from '../../icon/src/';
...
stories.add('ShareGroup', () => (
  ...
  >
    ...
    <ShareLink
      label="Email"
      icon={<Mail width={'100%'} height={'100%'} />}
      url="email.com/share"
    />
    <ShareLink
      label="Bug"
      icon={
        <Icon viewBox="0 0 314.01 266.89" width={'100%'} height={'100%'}>
          <g>
            <path
    ...
    <ReplayButton
      ...
      icon={<Replay width={'100%'} height={'100%'} />}
